        ...
        <div className="auth-card fade-in" style={{ maxWidth: 440 }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <input className="form-control-custom" type="email" placeholder="admin@uniskillswap.com"
            ...
            <div className="mb-4">
              ...
              <input className="form-control-custom" placeholder="000000" maxLength={6}
                value={form.code} onChange={e => set('code', e.target.value)} />
              <div style={{ color: 'var(--text-muted)', fontSize: '0.8rem', marginTop: 4 }}>Enter the 6-digit code from your authenticator app</div>
            </div>
          ...
          <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
            Don't have an admin account? <Link to="/admin/register" style={{ color: 'var(--primary)', fontWeight: 600 }}>Sign up</Link>
          </p>
          <p style={{ textAlign: 'center', fontSize: '0.9rem' }}>
            <Link to="/login" style={{ color: 'var(--primary)' }}>← Back to regular login</Link>
          </p>

          <div style={{ background: '#fff8e1', border: '1px solid #ffe082', borderRadius: 8, padding: '0.75rem 1rem', marginTop: '1.25rem' }}>
            <small style={{ color: '#856404' }}><strong>Security Notice:</strong> Admin access requires two-factor authentication and is monitored for security purposes.</small>
          </div>
        </div>
      </div>
    </div>
